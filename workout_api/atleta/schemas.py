...
class AtletaUpdate(BaseSchema):
    ...
    idade: Annotated[Optional [int], Field(None, description = 'Idade do atleta', examples =[20])]
    altura: Annotated[Optional [PositiveFloat], Field(None, description = 'Altura do atleta', examples =[1.90])]